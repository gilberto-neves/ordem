        ...
        <div class="block">
            ...
            <div class="block-body">
                ...
                <div class="form-group mt-5 mb-2">
                    ...
                    <a href="<?php echo site_url("admin/grupos")  ?>" class="btn btn-secondary ml-2">Voltar</a>
    ...
    $(document).ready(function() {
        $("#form").on('submit', function(e) {
            ...
            $.ajax({
                ...
                type: 'POST',
                url: '<?php echo site_url('admin/grupos/cadastrar');  ?>',
                ...
                success: function(response) {
                    ...
                    if (!response.erro) {
                        ...
                        window.location.href = "<?php echo site_url("admin/grupos/exibir/"); ?>" + response.id;
