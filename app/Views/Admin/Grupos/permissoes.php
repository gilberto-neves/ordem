    ...
    <div class="col-lg-6">
        <div class="user-block block">
            ...
            <?php if (empty($permissoesDisponiveis)) :  ?>
                ...
                <p class="contributions text-danger mt-0">Esse grupo já possui todas as permissões disponíveis!</p>
            ...
            <?php else : ?>
                ...
                <div class="form-group">
                    ...
                    <select name="permissao_id[]" class="selectize" id="selectize" multiple>
    ...
    <div class="col-lg-6">
        <div class="user-block block text-center">
            ...
            <?php if (empty($grupo->permissoes)) : ?>
                <p class="contributions text-danger mt-0">Esse grupo ainda não possui permissões de acesso!</p>
            <?php else :  ?>
                <div class="table-responsive">
                            ...
                            <?php foreach ($grupo->permissoes as $permissao) :  ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        ?>
                                        <?php echo form_open("admin/grupos/removepermissao/$permissao->principal_id", $atributos); ?>
                    ...
                    <?php echo $grupo->pager->links('default', 'bootstrap_pagination');  ?>
                </div>
            <?php endif;  ?>
    ...
    $(document).ready(function() {
        ...
        $("#form").on('submit', function(e) {
            ...
            $.ajax({
                ...
                type: 'POST',
                url: '<?php echo site_url('admin/grupos/salvarpermissoes');  ?>',
                ...
                success: function(response) {
                    ...
                    if (!response.erro) {
                        ...
                        window.location.href = "<?php echo site_url("admin/grupos/permissoes/$grupo->id"); ?>";
