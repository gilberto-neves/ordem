    ...
    <div class="col-lg-6">
        <div class="block">
            ...
            <div class="block-body">
                ...
                <?php echo form_open('Admin/Usuarios', ['id' => 'form'], ['id' => "$usuario->id"]); ?>

                <?php echo $this->include('Admin/Usuarios/_form');  ?>
    ...
    $(document).ready(function() {
        $("#form").on('submit', function(e) {
            ...
            $.ajax({
                ...
                type: 'POST',
                url: '<?php echo site_url('admin/usuarios/cadastrar');  ?>',
                ...
                success: function(response) {
                    ...
                    if (!response.erro) {
                        ...
                        if (response.info) {
                            ...
                            window.location.href = "<?php echo site_url("admin/usuarios/exibir/"); ?>" + response.id;
                        }
